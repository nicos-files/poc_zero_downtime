-- Generated 2025-12-09T17:43:27.111197Z  entity=ebom_062104
...
CREATE OR REPLACE STREAM ebom_062104_public_v2
  WITH (
    KAFKA_TOPIC='ebom_062104_public_v2',
    VALUE_FORMAT='JSON',
    KEY_FORMAT='JSON'
  ) AS
SELECT
  ebom_062104_base.ROWKEY AS ROWKEY,
...
WHERE (COALESCE(CAST(ebom_062104_base.__deleted AS STRING), 'false') = 'false')
EMIT CHANGES;
