-- Generated 2025-12-09T17:43:25.674858Z  entity=update_specifics1
...
CREATE OR REPLACE STREAM update_specifics1_public_v2
  WITH (
    KAFKA_TOPIC='update_specifics1_public_v2',
    VALUE_FORMAT='JSON',
    KEY_FORMAT='JSON'
  ) AS
SELECT
  update_specifics1_base.ROWKEY AS ROWKEY,
...
WHERE (COALESCE(CAST(update_specifics1_base.__deleted AS STRING), 'false') = 'false')
EMIT CHANGES;
