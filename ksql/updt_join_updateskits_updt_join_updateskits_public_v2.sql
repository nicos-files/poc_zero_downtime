-- Generated 2025-12-09T17:43:26.948126Z  entity=updt_join_updateskits
...
CREATE OR REPLACE STREAM updt_join_updateskits_public_v2
  WITH (
    KAFKA_TOPIC='updt_join_updateskits_public_v2',
    VALUE_FORMAT='JSON',
    KEY_FORMAT='JSON'
  ) AS
SELECT
  updt_join_updateskits_base.ROWKEY AS ROWKEY,
...
WHERE (COALESCE(CAST(updt_join_updateskits_base.__deleted AS STRING), 'false') = 'false')
EMIT CHANGES;
